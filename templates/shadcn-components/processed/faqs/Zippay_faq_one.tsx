...
export default function ZippayFaqOne({
  tagline = 'FAQs',
    ...
    >
      <div className="container">
        <div className="mx-auto flex max-w-3xl flex-col items-center justify-center text-center">
          ...
          <h2 className="text-foreground text-4xl lg:text-5xl font-bold mt-4 tracking-tight lg:text-[52px]">
            {title}
          </h2>
          <p className="text-base sm:text-lg mt-4 max-w-[568px] text-muted-foreground">
            {description}
          </p>
        </div>
              ...
              >
                <div
                  className={cn(
                    ...
                    softBg ? 'bg-background' : 'bg-gray-25',
                  )}
                >
                  <AccordionTrigger
                    className={cn(
