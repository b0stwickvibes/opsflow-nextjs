...
/**
 * Industry FAQ Component - Clean accordian-style FAQ with support sidebar
 * 
 * BARS-DEMO-DESIGN-STANDARDS COMPLIANCE:
 * - clerk-inspired-badge for badge elements
 * - Ultra-clean Clerk.com accordion styling
 * - Category color coding for FAQ items
 * - Sticky support sidebar with resources
...
export function IndustryFAQ({
  ...
  return (
    <section className={`py-24 bg-gradient-to-b from-white to-slate-50/30 ${className}`}>
...
export type { IndustryFAQProps, FAQItem, SupportCTA };
