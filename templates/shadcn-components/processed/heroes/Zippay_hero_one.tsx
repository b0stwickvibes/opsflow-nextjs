...
export type ZippayHeroOneProps = {
  logos?: LogoItem[];
};
...
export default function ZippayHeroOne({ logos = DEFAULT_LOGOS }: ZippayHeroProps) {
  return (
    <section
      id="zippayheroone"
    ...
    >
      <div
        className="bg-primary absolute inset-y-0 right-0 z-0 hidden overflow-hidden lg:block"
        style={{
          ...
          <div className="grid pt-10 lg:[grid-template-columns:minmax(0,1fr)_clamp(420px,40vw,480px)] lg:gap-16 lg:py-24">
            <div className="flex flex-col justify-between gap-8 pb-6">
              <div className="flex flex-col gap-8">
                <div className="flex flex-col items-start gap-4">
                  <span className="text-sm font-medium bg-background inline-flex h-8 w-fit items-center justify-center gap-2 rounded-[10px] border border-border px-3 leading-none whitespace-nowrap shadow-[0_1px_2px_0_rgba(13,13,18,0.06)]">
                    <Image
                  ...
                  <h1 className="text-foreground text-4xl lg:text-5xl font-bold leading-[1.05] font-bold tracking-tight lg:text-[68px] lg:leading-[125%]">
            ...
            <div className="min-w-0">
              <div className="relative">
                <div className="bg-primary absolute inset-y-0 left-1/2 z-0 w-screen -translate-x-1/2 lg:hidden" />
