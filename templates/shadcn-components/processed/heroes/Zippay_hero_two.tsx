...
export type ZippayHeroTwoProps = {
  tagline?: string;
  title?: string;
  description?: string;
  primaryHref?: string;
...
export default function ZippayHeroTwo({
    ...
    <section className="bg-gray-25 px-6 py-10 lg:py-24 dark:bg-gray-200">
      <div className="container">
        <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-16">
          <div>
            <span className="text-body-xs-medium bg-background inline-flex h-8 items-center gap-2 rounded-[10px] border border-border px-3 py-0 leading-none shadow-[0_1px_2px_0_rgba(13,13,18,0.06)]">
              <Image
            ...
            <h1 className="text-foreground text-4xl lg:text-5xl font-bold mt-4 max-w-[680px] tracking-tight lg:text-[68px] lg:leading-[125%]">
              {title}
            </h1>
          </div>
