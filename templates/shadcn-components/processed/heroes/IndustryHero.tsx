...
import { Wine, BarChart3, ArrowRight, Play } from "lucide-react";
...
/**
 * Industry Hero Component - Professional industry-focused hero section
 * 
 ...
 * - clerk-cta-primary for primary CTA buttons
...
export function IndustryHero({
  ...
  return (
    <section className={`section-marketing hero-ambient energy-balanced overflow-hidden ${className}`}>
