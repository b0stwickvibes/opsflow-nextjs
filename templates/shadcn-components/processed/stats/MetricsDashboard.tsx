  ...
  return (
    <section className="py-32">
      <div className="container">
        <div className="relative isolate overflow-hidden md:border-x md:border-border" 
             style={{ background: `linear-gradient(to bottom, oklch(from ${config.color} l c h / 0.1), transparent)` }}>
          ...
          <div>
            ...
            <div className="relative grid max-w-2xl gap-4 border-x border-border pb-32 sm:grid-cols-2 sm:gap-10 sm:pb-44 md:ml-10 md:border-0">
              {/* Decorative Circle */}
              <div 
                className="absolute inset-0 -top-[1100px] -left-[calc(1000px-22vw)] -z-10 size-[1500px] rounded-full border bg-background sm:-top-[480%] sm:-left-[185%] sm:size-[2000px] md:-top-[906%] md:-left-[294%] md:size-[3500px] lg:-top-[1186%] lg:-left-[380%] lg:size-[4500px] xl:-top-[1200%] xl:-left-[350%] 2xl:-top-[1196%] 2xl:-left-[345%]"
                style={{ borderColor: `oklch(from ${config.color} l c h / 0.2)` }}
              />
              ...
              {config.metrics.map((metric, index) => (
                ...
                >
                  <span className="flex gap-5 text-3xl font-semibold">
                    <span 
                      className="relative -left-px w-px opacity-50"
