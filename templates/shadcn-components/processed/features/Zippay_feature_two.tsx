...
export type ZippayFeatureTwoProps = {
  tagline?: string;
  title?: string;
  description?: string;
  items?: FeatureItem[];
...
export default function ZippayFeatureTwo({
  tagline = 'Features',
    ...
    <section className="px-6 py-10 lg:py-24">
      <div className="container">
        <div className="max-w-3xl">
          ...
          <h2 className="text-foreground text-4xl lg:text-5xl font-bold mt-3 tracking-tight lg:text-[52px]">
            {title}
          </h2>
          ...
          <div>
            ...
            >
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <span className="text-base-medium">{it.label}</span>
                      </div>
                    </button>
                  );
                })}
              ...
              <div className="mt-6 max-w-prose">
                <p className="text-base text-muted-foreground">{current.body}</p>
                {current.href && (
                  <div className="mt-4">
                    <Button
                      asChild
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      open ? 'border-primary border-b-2' : 'border-border',
                    )}
                  >
                    <button
                      onClick={() => setActive(it.key)}
