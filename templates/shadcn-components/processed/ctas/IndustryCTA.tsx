...
/**
 * Industry CTA Component - Final conversion-focused section
 * 
 * BARS-DEMO-DESIGN-STANDARDS COMPLIANCE:
 * - clerk-inspired-badge for urgency badge
 * - enterprise-headline for main headline
 * - heading-brand-gradient for subheadline
 * - enterprise-body for description
 * - clerk-cta-primary for primary CTA
 * - enterprise-card for testimonial
 * - hero-ambient energy-balanced for section styling
...
export type { IndustryCTAProps, TrustIndicator, Testimonial };
