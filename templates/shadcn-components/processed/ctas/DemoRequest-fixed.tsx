...
export function DemoRequest({ industry = "restaurants" }: DemoRequestProps) {
  ...
  const industryConfig = {
    ...
    hotels: {
      ...
      subtitle: "Learn how 300+ hotels manage dining excellence",
      benefits: [
  ...
  const handleScheduleDemo = () => {
    ...
    console.log(`Scheduling demo for ${industry}`);
  };
      ...
      >
        ...
        <div className="relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="enterprise-headline text-3xl md:text-4xl font-bold mb-4">
              {config.title}
            </h2>
