...
import { ErrorBoundary as ReactErrorBoundary, ErrorInfo, ReactNode } from 'react';
...
export class ErrorBoundary extends ReactErrorBoundary<Props, ErrorBoundaryState> {
