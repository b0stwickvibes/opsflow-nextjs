// Features Page v1 - Original Implementation (BACKUP)
// Kept for reference - simpler layout with SplitFeature components
// v2 uses comprehensive block system for better conversion
// Date: 2024-09-02
