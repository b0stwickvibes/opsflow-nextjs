...
export default function TemplateCatalogPage() {
  ...
  const templates = [
    ...
    { id: 13, title: "Feature Bento (Clean)", category: "feature", component: CleanFeatureBento, props: { industry: 'restaurant' as const }, description: "Clean Clerk-inspired feature bento layout" },
    { id: 12, title: "Feature Carousel", category: "feature", component: FeatureCarousel, props: {}, description: "Feature carousel slider" },
    { id: 13, title: "Feature Highlight", category: "feature", component: FeatureHighlight, props: {}, description: "Highlighted feature section" },
    { id: 14, title: "Feature List", category: "feature", component: FeatureList, props: {}, description: "Simple feature list" },
    { id: 15, title: "Feature Showcase 2", category: "feature", component: FeatureShowcase2, props: {}, description: "Alternative feature showcase" },
    { id: 16, title: "Feature Split", category: "feature", component: FeatureSplit, props: {}, description: "Split layout feature section" },
    { id: 17, title: "Feature Tabs", category: "feature", component: FeatureTabs, props: {}, description: "Tabbed feature content" },
    { id: 18, title: "Feature Timeline", category: "feature", component: FeatureTimeline, props: {}, description: "Feature timeline display" },
    { id: 19, title: "Pricing Comparison", category: "pricing", component: PricingComparison, props: { industry: 'restaurants' as const }, description: "Pricing comparison layout" },
    { id: 20, title: "Contact Form", category: "contact", component: ContactForm, props: {}, description: "Contact form component" },
    { id: 21, title: "Lead Capture", category: "contact", component: LeadCapture, props: {}, description: "Lead capture form" },
    { id: 22, title: "KPI Showcase", category: "testimonial", component: KPIShowcase, props: {}, description: "Key performance indicators" },
    { id: 23, title: "Stats Display", category: "testimonial", component: StatsDisplay, props: {}, description: "Statistics display component" },
    { id: 24, title: "Metrics Dashboard", category: "testimonial", component: MetricsDashboard, props: {}, description: "Dashboard for metrics" },
    { id: 25, title: "Call To Action", category: "cta", component: CallToAction, props: {}, description: "Call to action section" },
    { id: 26, title: "Demo Request (Enhanced)", category: "cta", component: DemoRequest, props: { industry: 'restaurant' as const }, description: "Premium demo booking with glassmorphism design, Stripe/Clerk-style enhancements, and featured blue calendar icon" },
    { id: 27, title: "Trial Signup (Enhanced)", category: "cta", component: TrialSignup, props: { industry: 'restaurant' as const }, description: "Premium trial signup with glassmorphism design, Stripe/Clerk-style enhancements, and featured calendar demo booking" },
    { id: 28, title: "Restaurant CTA (Primary)", category: "cta", component: RestaurantCTA, props: { industry: 'restaurant' as const }, description: "Restaurant-focused CTA with social proof" },
    { id: 29, title: "Restaurant Trial CTA", category: "cta", component: RestaurantTrialCTA, props: {}, description: "Simple trial-focused CTA" },
    { id: 30, title: "Restaurant Demo CTA", category: "cta", component: RestaurantDemoCTA, props: {}, description: "Demo-focused CTA with benefits" },
    { id: 31, title: "Compliance FAQ", category: "faq", component: ComplianceFAQ, props: {}, description: "Compliance frequently asked questions" },
    { id: 32, title: "Support FAQ", category: "faq", component: SupportFAQ, props: {}, description: "Support frequently asked questions" },
    { id: 33, title: "FAQ Section", category: "faq", component: FAQSection, props: {}, description: "General FAQ section" },
    { id: 34, title: "About Section", category: "about", component: AboutSection, props: {}, description: "About us section" },
    { id: 35, title: "Bento Grid", category: "bento", component: BentoGrid, props: {}, description: "Grid layout for bento" },
    { id: 36, title: "Bento Layout", category: "bento", component: BentoLayout, props: {}, description: "Flexible bento layout" },
    { id: 37, title: "Premium Bento Section", category: "bento", component: PremiumBentoSection, props: { industry: 'restaurants' as const }, description: "Premium restaurant operations showcase with live metrics and glassmorphism design" },
    { id: 38, title: "Comparison Table", category: "compare", component: ComparisonTable, props: {}, description: "Table for comparing items" },
    { id: 39, title: "Competitor Analysis", category: "compare", component: CompetitorAnalysis, props: {}, description: "Analysis of competitors" },
    { id: 40, title: "Feature Rolling Blocks", category: "feature", component: FeatureRollingBlocks, props: {}, description: "Rolling blocks for marketing/operations features" },
  ];
