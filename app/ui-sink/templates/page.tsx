...
export default function TemplateCatalogPage() {
  ...
  const templates = [
    ...
    { id: 52, title: "Industry CTA (Template)", category: "cta", component: () => <div className="p-8 text-center text-muted-foreground">IndustryCTA component requires props</div>, props: {
