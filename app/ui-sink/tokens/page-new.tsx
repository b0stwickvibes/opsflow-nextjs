...
const VisualToken: React.FC<VisualTokenProps> = ({ className, description, category, children }) => {
  ...
  const renderVisual = () => {
    switch (category) {
      ...
      case 'surface':
        return <div className={`w-full h-16 rounded-lg border ${className}`} />;
      default:
    ...
    <main className="container mx-auto py-8 px-4 max-w-7xl">
      <section className="space-y-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <VisualToken className="surface-subtle-primary border" description="Subtle Primary Surface" category="surface" />
              <VisualToken className="surface-subtle-secondary border" description="Subtle Secondary Surface" category="surface" />
              <VisualToken className="surface-subtle-muted border" description="Subtle Muted Surface" category="surface" />
              <VisualToken className="bg-surface-subtle-primary" description="Primary Surface BG" category="surface" />
              <VisualToken className="bg-surface-subtle-secondary" description="Secondary Surface BG" category="surface" />
              <VisualToken className="light-bg-brand-gradient" description="Light Brand Gradient" category="surface" />
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              <VisualToken className="dashboard-metric-cyan p-4 rounded-lg border" description="Metric Cyan" category="surface" />
              <VisualToken className="dashboard-metric-green p-4 rounded-lg border" description="Metric Green" category="surface" />
              <VisualToken className="dashboard-metric-blue p-4 rounded-lg border" description="Metric Blue" category="surface" />
              <VisualToken className="dashboard-metric-purple p-4 rounded-lg border" description="Metric Purple" category="surface" />
              <VisualToken className="dashboard-metric-restaurant p-4 rounded-lg border" description="Restaurant Metric" category="surface" />
              <VisualToken className="dashboard-metric-bar p-4 rounded-lg border" description="Bar Metric" category="surface" />
              <VisualToken className="dashboard-metric-coffee p-4 rounded-lg border" description="Coffee Metric" category="surface" />
              <VisualToken className="dashboard-metric-hotel p-4 rounded-lg border" description="Hotel Metric" category="surface" />
            </div>
          </CardContent>
        </Card>
