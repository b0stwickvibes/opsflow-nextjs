...
/**
 * RestaurantsProcessSolutions Component
 *
 * Two-column layout showing problem/solution pairs with sticky sidebar.
 * Features clean cards with blue accents and metrics display.
...
export interface RestaurantsProcessSolutionsProps {
  title: string;
  description: string;
  badge: string;
...
export function RestaurantsProcessSolutions({
  title,
  description,
  badge,
  processSolutions,
          ...
          <div className="lg:sticky lg:top-24 lg:self-start space-y-6">
            ...
            <div className="clerk-glass-card p-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                See these improvements in your restaurant within the first month
              </p>
              <button
