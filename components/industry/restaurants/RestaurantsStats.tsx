...
interface RestaurantsStatsProps {
  title: string;
  description: string;
  stats: {
    icon: LucideIcon;
...
/**
 * RestaurantsStats Component - Clean stats display for restaurants
 *
 ...
 * - Blue accent theme inherited from parent .accent-blue
 ...
 *     <RestaurantsStats {...props} />
 *   </SectionContent>
 * </Section>
 */
export function RestaurantsStats({
  title,
  description,
  stats,
  className = ""
}: RestaurantsStatsProps) {
  return (
    <div className={className}>
      ...
      <div className="text-center mt-16 motion-fade-in-up-320 animation-delay-500">
        <p className="text-sm text-muted-foreground">
          Join 1,000+ restaurants optimizing operations with OpsFlow
        </p>
      </div>
    </div>
  );
...
export default RestaurantsStats;
export type { RestaurantsStatsProps };
