...
import { ChefHat, BarChart3, ArrowRight, Play, CheckCircle } from "lucide-react";
import { Button } from "@/components/ui/button";

interface RestaurantsHeroProps {
  industry: string;
  headline: string;
  subheadline: string;
  description: string;
...
/**
 * RestaurantsHero Component - Industry-specific hero section for restaurants
 *
 ...
 * - Restaurant-specific terminology and metrics
...
export type { RestaurantsHeroProps };
