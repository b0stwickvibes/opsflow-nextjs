...
/**
 * RestaurantsProcess Component
 *
 * Displays the 3-step implementation process for restaurant operations.
 * Features stepped progression with clean Clerk.com styling and BLUE checkboxes.
 *
 * ENTERPRISE DESIGN STANDARDS:
 * - Section-compatible: No internal section/container wrappers
 * - Uses OKLCH color tokens + blue checkboxes for restaurants theme
 * - Icon containers: primary (cyan), roi (blue center), secondary (cyan)
 * - Adapts to parent accent theme (blue for restaurants via .accent-blue)
 *
 * USAGE:
 * <Section background="default" padding="lg">
 *   <SectionContent maxWidth="6xl">
 *     <RestaurantsProcess {...props} />
 *   </SectionContent>
 * </Section>
 */
...
export interface RestaurantsProcessProps {
  title: string;
  description: string;
  badge: string;
  steps: ProcessStep[];
...
export function RestaurantsProcess({
  title,
  description,
  badge,
  steps,
  className = ""
}: RestaurantsProcessProps) {
  return (
              ...
              >
                ...
                <div className="clerk-glass-card p-10 h-full">
                  <div className="space-y-8">
                    ...
                    {/* Details list with BLUE checkboxes (restaurants theme) */}
                    <div className="space-y-4">
