...
/**
 * RestaurantPlatformFeaturesGrid Component
 *
 * Interactive feature grid with selectable cards and detailed showcase.
 * Features blue checkbox accents and restaurant operations dashboard mockup.
...
export interface RestaurantPlatformFeature {
  id: string;
  type: string;
  title: string;
  description: string;
...
export interface RestaurantPlatformFeaturesGridProps {
  badge: string;
  title: string;
  subtitle: string;
  features: RestaurantPlatformFeature[];
}

export function RestaurantPlatformFeaturesGrid({
  badge,
  title,
  subtitle,
  features
}: RestaurantPlatformFeaturesGridProps) {
