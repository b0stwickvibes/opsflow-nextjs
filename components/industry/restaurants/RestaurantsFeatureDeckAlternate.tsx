...
/**
 * RestaurantsFeatureDeckAlternate Component - Stripe-Style Carousel
 *
 * Premium carousel showcasing advanced restaurant features with smooth horizontal scrolling.
 * Inspired by Stripe.com carousel patterns with Clerk.com styling.
 * Adapts to parent accent theme (blue for restaurants via .accent-blue wrapper)
 *
 * Used in: /app/solutions/restaurants
...
export interface RestaurantsFeatureDeckAlternateProps {
  title: string;
  description: string;
  badge?: string;
...
export function RestaurantsFeatureDeckAlternate({
  title,
  description,
  badge,
  features
}: RestaurantsFeatureDeckAlternateProps) {
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                  Advanced analytics and growth tools designed for serious restaurant operators.
                </p>
              </div>
