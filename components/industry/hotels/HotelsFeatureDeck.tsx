...
/**
 * HotelsFeatureDeck Component
 *
 * Displays core hotel management features in a 3-column grid layout.
 * Features clean Clerk.com styling with RED checkbox accents (hotels theme).
 *
 * ENTERPRISE DESIGN STANDARDS:
 * - Section-compatible: No internal section/container wrappers
 * - Uses OKLCH color tokens with red checkboxes for hotels theme
...
export interface HotelsFeatureDeckProps {
  title: string;
  description: string;
  badge?: string;
  features: Feature[];
...
export function HotelsFeatureDeck({
  title,
  description,
  badge,
  features,
  ...
  return (
    <div className={className}>
      ...
      {/* Features Grid - Clerk.com Clean Style with RED checkboxes */}
          ...
          return (
            ...
            >
              <div className="bg-background border border-border rounded-3xl p-8 h-full group hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 transition-all duration-500">
                ...
                {/* Benefits - Clean List with RED checkboxes (hotels theme) */}
