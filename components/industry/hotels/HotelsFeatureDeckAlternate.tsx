...
/**
 * HotelsFeatureDeckAlternate Component - Stripe-Style Carousel
 *
 * Premium carousel showcasing advanced hotel features with smooth horizontal scrolling.
...
export interface HotelsFeatureDeckAlternateProps {
  title: string;
  description: string;
  badge?: string;
...
export function HotelsFeatureDeckAlternate({
  title,
  description,
  badge,
  features
}: HotelsFeatureDeckAlternateProps) {
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h3 className="text-3xl font-bold text-foreground">
                  Ready to Scale Your Hotel Operations?
                </h3>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                  Advanced analytics and management tools designed for serious hotel operators.
                </p>
              </div>
