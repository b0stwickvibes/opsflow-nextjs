...
/**
 * HotelPlatformFeaturesGrid Component
 *
 * Interactive feature grid with selectable cards and detailed showcase.
 * Features red checkbox accents and hotel operations dashboard mockup.
...
export interface HotelPlatformFeature {
  id: string;
  type: string;
  title: string;
  description: string;
...
export interface HotelPlatformFeaturesGridProps {
  badge: string;
  title: string;
  subtitle: string;
  features: HotelPlatformFeature[];
}

export function HotelPlatformFeaturesGrid({
  badge,
  title,
  subtitle,
  features
}: HotelPlatformFeaturesGridProps) {
