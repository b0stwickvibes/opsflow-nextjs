 ...
 * Features clean Clerk.com styling with red accents.
...
export function HotelsFAQ({
  ...
  const getCategoryColor = (category?: string) => {
    switch (category) {
      ...
      case "pricing": return "bg-red-50 text-red-700 border-red-200";
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 pt-8 border-t border-slate-200/60 motion-fade-in-up-320 animation-delay-400">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-2xl font-bold bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent mb-1">99%</div>
              <div className="text-sm dashboard-text-muted">Questions resolved instantly</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-gradient mb-1">90sec</div>
            ...
            <div>
              ...
              <div className="text-sm dashboard-text-muted">Satisfied hotels</div>
            </div>
          </div>
        </div>
      </div>
