...
/**
 * HotelsStats Component - Clean stats display for hotels and hospitality venues
 *
    ...
    <div className={className}>
      ...
      <div className="text-center mt-16 motion-fade-in-up-320 animation-delay-500">
        <p className="text-sm text-muted-foreground">
          Join 500+ hotels and hospitality venues optimizing operations with OpsFlow
        </p>
      </div>
    </div>
  );
...
export default HotelsStats;
export type { HotelsStatsProps };
