...
/**
 * HotelsProcessSolutions Component
 *
 * Two-column layout showing problem/solution pairs with sticky sidebar.
 * Features clean cards with red accents and metrics display.
...
export interface HotelsProcessSolutionsProps {
  title: string;
  description: string;
  badge: string;
...
export function HotelsProcessSolutions({
  title,
  description,
  badge,
  processSolutions,
  bottomCTA
}: HotelsProcessSolutionsProps) {
  return (
          ...
          <div className="lg:sticky lg:top-24 lg:self-start space-y-6">
            ...
            <div className="clerk-glass-card p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground">
                    Multi-venue tracking precision
                  </div>
                </div>
            ...
            <div className="clerk-glass-card p-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                See these improvements in your hotel within the first month
              </p>
              <button
            ...
            <div className="bg-gradient-to-br from-slate-50 to-white border border-slate-200 rounded-3xl p-12 text-center max-w-4xl mx-auto">
              <div className="space-y-8">
                ...
                <div className="pt-6 border-t border-slate-200">
                  <p className="text-sm text-muted-foreground">
                    Trusted by 500+ hotels • PCI DSS compliant • 99.9% uptime
                  </p>
                </div>
              </div>
            </div>
