...
/**
 * BarsFeatureDeck Component
 * 
 * Displays core bar management features in a 3-column grid layout.
 * Features clean Clerk.com styling with PURPLE checkbox accents (bars theme).
 * 
 * ENTERPRISE DESIGN STANDARDS:
 * - Section-compatible: No internal section/container wrappers
 * - Uses OKLCH color tokens with purple checkboxes for bars theme
...
export interface BarsFeatureDeckProps {
  title: string;
  description: string;
  badge?: string;
  features: Feature[];
...
export function BarsFeatureDeck({ 
  title, 
  description, 
  badge, 
  features, 
          ...
          return (
            ...
            >
              <div className="bg-background border border-border rounded-3xl p-8 h-full group hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 transition-all duration-500">
                ...
                {/* Benefits - Clean List with PURPLE checkboxes (bars theme) */}
