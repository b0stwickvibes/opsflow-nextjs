...
export function OriginalContactForm() {
  ...
  return (
    <div className="relative">
      {/* Background elements */}
      <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-blue-50/50 to-transparent dark:from-blue-950/30 dark:to-transparent -z-10" />
      <div className="absolute top-1/4 left-0 w-1/4 h-1/2 bg-gradient-to-r from-indigo-50/50 to-transparent dark:from-indigo-950/30 dark:to-transparent -z-10" />
      <div className="absolute bottom-0 left-1/3 right-1/3 h-1/3 bg-gradient-to-t from-slate-50/50 to-transparent dark:from-slate-950/30 dark:to-transparent -z-10" />
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            ...
            <Textarea 
              ...
              className="min-h-[150px] border-slate-300 dark:border-slate-700 focus:border-blue-500 dark:focus:border-blue-400" 
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex items-start animate-slide-up" style={{animationDelay: "200ms"}}>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                <a href="mailto:support@opsflow.ai" className="hover:text-blue-600 transition-colors">
                  support@opsflow.ai
                </a>
              </p>
            </div>
          ...
          <div className="flex items-start animate-slide-up" style={{animationDelay: "300ms"}}>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                <a href="tel:8001234567" className="hover:text-blue-600 transition-colors">
                  (800) 123-4567
                </a>
              </p>
            </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg mt-8 animate-fade-in" style={{animationDelay: "600ms"}}>
